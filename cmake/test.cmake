...
set(HDFTESTS)
if (MAT73)
    set(HDFTESTS uncompressed_hdf compressed_hdf)
    set(hdf_vars ${vars})
    set(uncompressed_hdf ${vars})
    set(compressed_hdf ${vars})
endif()
...
foreach(endian le be)
    set(POSSIBLE_VERSIONS v4 compressed uncompressed)
    if(MAT73)
        if(${endian} STREQUAL le)
            set(POSSIBLE_VERSIONS ${POSSIBLE_VERSIONS} uncompressed_hdf compressed_hdf)
        else()
            set(POSSIBLE_VERSIONS ${POSSIBLE_VERSIONS} hdf)
        endif()
    endif()
    foreach(vers ${POSSIBLE_VERSIONS})
